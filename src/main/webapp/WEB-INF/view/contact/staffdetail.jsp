<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <title>Staff Contact Detail — Booktify</title>
                ...
                <header class="admin-topbar">
                    <div class="admin-topbar__brand">
                        ...
                        <div>
                            ...
                            <p>Contact request detail and customer conversation</p>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail-grid">
                        ...
                        <div class="contact-detail-column">
                            ...
                            <section class="admin-panel">
                                ...
                                <table class="contact-detail-table">
                                    ...
                                    <c:if test="${not empty request.orderCode}">
                                        <tr>
                                            <th>Order</th>
                                            <td>
                                                <c:out value="${request.orderCode}" />
                                            </td>
                                        </tr>
                                    </c:if>
                                ...
                                <form action="/staff/contacts/${request.id}/status" method="post"
                        ...
                        <div class="contact-detail-column">
                            ...
                            <section class="admin-panel">
                                        ...
                                        <c:when test="${not empty messages}">
                                            <c:forEach var="msg" items="${messages}">
                                                ...
                                                <div class="contact-chat-message ${isMe ? 'me' : 'other'}">
                                                    ...
                                                    <div class="contact-chat-bubble"><c:out value="${msg.message}" /></div>
                                                </div>
                                ...
                                <form action="/staff/contacts/${request.id}/chat" method="post"
