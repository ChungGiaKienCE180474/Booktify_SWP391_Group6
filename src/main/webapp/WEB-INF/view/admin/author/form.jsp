                                ...
                                <div class="admin-form-card__body">
                                    <form:form modelAttribute="authorDTO" action="${formAction}" method="post"
                                        ...
                                        <div class="admin-field">
                                            ...
                                            <img id="previewImage" src="${authorDTO.profileImage}" style="margin-top:10px;
                                                    max-width:180px;
                                                    border-radius:8px;
                                                    border:1px solid #ddd;
                                                    ${empty authorDTO.profileImage ? 'display:none;' : ''}">
                                        </div>
