    ...
    <div class="header-topbar-inner">
        ...
        <div class="header-topbar-right">
            <c:choose>
                ...
                <c:otherwise>
                    <span>Xin chào, <strong>${not empty sessionScope.fullName ? sessionScope.fullName : sessionScope.username}</strong></span>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div class="hdr-auth-btns">
                        <a href="/login" class="btn-hdr btn-hdr-ghost">Đăng nhập</a>
                        <a href="/register" class="btn-hdr btn-hdr-solid">Đăng ký</a>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
