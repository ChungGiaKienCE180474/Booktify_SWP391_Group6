...
<head>
    ...
    <title>Add Category - Booktify</title>
</head>
<body>
        ...
        <div class="page-container page-container-narrow">
            ...
            <div class="form-card">
                ...
                <div class="form-card-body">
                    ...
                    <form:form method="post" action="/stationery/categories/create"
                               modelAttribute="stationeryCategory" novalidate="true">

                        <div class="form-group">
                            <label class="form-label">Category Name <span class="required">*</span></label>
                            <form:input path="name" cssClass="form-input" placeholder="Enter category name..." />
